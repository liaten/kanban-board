...
public class Main extends AppCompatActivity {
    ...
    private void showMainWindow() {
        ...
        DatabaseReference reference_login = com.google.firebase.database.FirebaseDatabase.getInstance().getReference("Users");
    ...
    private void showForgotWindow() {
        ...
        forgot.setNegativeButton("Назад", (dialogInterface, i) -> dialogInterface.dismiss());
        forgot.setPositiveButton("Отправить", (dialogInterface, i) -> {
        });
        forgot.show();
    }
    // Регистрация
    private void showRegisterWindow() {
        ...
        final MaterialEditText emailEditText = reg_window.findViewById(R.id.email_field);
        final MaterialEditText loginEditText = reg_window.findViewById(R.id.login_field);
        final MaterialEditText passwordEditText = reg_window.findViewById(R.id.password_field);
        final MaterialEditText fullNameEditText = reg_window.findViewById(R.id.full_name_field);
        final MaterialEditText organizationEditText = reg_window.findViewById(R.id.org_field);
        reg.setNegativeButton("Назад", (dialogInterface, i) -> dialogInterface.dismiss());

        reg.setPositiveButton("Отправить", (dialogInterface, i) -> {
            ...
            if (TextUtils.isEmpty(organizationEditText.getText().toString())) {
            ...
            String login_u = loginEditText.getText().toString();
            String password_u = passwordEditText.getText().toString();
            String email_u = emailEditText.getText().toString();
            String fullName_u = fullNameEditText.getText().toString();
            String org_u = organizationEditText.getText().toString();
